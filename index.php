    ...
    <div id="sudoku-flex">
        ...
        <div class="table-container">
            ...
            <form>
                ...
                function colorCalculated(int $y, int $x): void
                {
                ...
                <div id="result-grid"><input inputmode="numeric" type="number" maxlength="1" min="1" max="9"
                        ...
                        class="top left <?php colorCalculated(0, 0); ?>" disabled><input inputmode="numeric"
                        type="number" maxlength="1" min="1" max="9" value="<?php printCell(0, 1); ?>" autocomplete="off"
                        class="top <?php colorCalculated(0, 1); ?>" disabled><input inputmode="numeric" type="number"
                        maxlength="1" min="1" max="9" value="<?php printCell(0, 2); ?>" autocomplete="off"
                        class="top <?php colorCalculated(0, 2); ?>" disabled><input inputmode="numeric" type="number"
                        maxlength="1" min="1" max="9" value="<?php printCell(0, 3); ?>" autocomplete="off"
                        class="top left <?php colorCalculated(0, 3); ?>" disabled><input inputmode="numeric"
                        type="number" maxlength="1" min="1" max="9" value="<?php printCell(0, 4); ?>" autocomplete="off"
                        class="top <?php colorCalculated(0, 4); ?>" disabled><input inputmode="numeric" type="number"
                        maxlength="1" min="1" max="9" value="<?php printCell(0, 5); ?>" autocomplete="off"
                        class="top <?php colorCalculated(0, 5); ?>" disabled><input inputmode="numeric" type="number"
                        maxlength="1" min="1" max="9" value="<?php printCell(0, 6); ?>" autocomplete="off"
                        class="top left <?php colorCalculated(0, 6); ?>" disabled><input inputmode="numeric"
                        type="number" maxlength="1" min="1" max="9" value="<?php printCell(0, 7); ?>" autocomplete="off"
                        class="top <?php colorCalculated(0, 7); ?>" disabled><input inputmode="numeric" type="number"
                        maxlength="1" min="1" max="9" value="<?php printCell(0, 8); ?>" autocomplete="off"
                        class="top right <?php colorCalculated(0, 8); ?>" disabled><br><input inputmode="numeric"
                        type="number" maxlength="1" min="1" max="9" value="<?php printCell(1, 0); ?>" autocomplete="off"
                        class="left <?php colorCalculated(1, 0); ?>" disabled><input inputmode="numeric" type="number"
                        maxlength="1" min="1" max="9" value="<?php printCell(1, 1); ?>" autocomplete="off"
                        class="<?php colorCalculated(1, 1); ?>" disabled><input inputmode="numeric" type="number"
                        maxlength="1" min="1" max="9" value="<?php printCell(1, 2); ?>" autocomplete="off"
                        class="<?php colorCalculated(1, 2); ?>" disabled><input inputmode="numeric" type="number"
                        maxlength="1" min="1" max="9" value="<?php printCell(1, 3); ?>" autocomplete="off"
                        class="left <?php colorCalculated(1, 3); ?>" disabled><input inputmode="numeric" type="number"
                        maxlength="1" min="1" max="9" value="<?php printCell(1, 4); ?>" autocomplete="off"
                        class="<?php colorCalculated(1, 4); ?>" disabled><input inputmode="numeric" type="number"
                        maxlength="1" min="1" max="9" value="<?php printCell(1, 5); ?>" autocomplete="off"
                        class="<?php colorCalculated(1, 5); ?>" disabled><input inputmode="numeric" type="number"
                        maxlength="1" min="1" max="9" value="<?php printCell(1, 6); ?>" autocomplete="off"
                        class="left <?php colorCalculated(1, 6); ?>" disabled><input inputmode="numeric" type="number"
                        maxlength="1" min="1" max="9" value="<?php printCell(1, 7); ?>" autocomplete="off"
                        class="<?php colorCalculated(1, 7); ?>" disabled><input inputmode="numeric" type="number"
                        maxlength="1" min="1" max="9" value="<?php printCell(1, 8); ?>" autocomplete="off"
                        class="right <?php colorCalculated(1, 8); ?>" disabled><br><input inputmode="numeric"
                        type="number" maxlength="1" min="1" max="9" value="<?php printCell(2, 0); ?>" autocomplete="off"
                        class="left <?php colorCalculated(2, 0); ?>" disabled><input inputmode="numeric" type="number"
                        maxlength="1" min="1" max="9" value="<?php printCell(2, 1); ?>" autocomplete="off"
                        class="<?php colorCalculated(2, 1); ?>" disabled><input inputmode="numeric" type="number"
                        maxlength="1" min="1" max="9" value="<?php printCell(2, 2); ?>" autocomplete="off"
                        class="<?php colorCalculated(2, 2); ?>" disabled><input inputmode="numeric" type="number"
                        maxlength="1" min="1" max="9" value="<?php printCell(2, 3); ?>" autocomplete="off"
                        class="left <?php colorCalculated(2, 3); ?>" disabled><input inputmode="numeric" type="number"
                        maxlength="1" min="1" max="9" value="<?php printCell(2, 4); ?>" autocomplete="off"
                        class="<?php colorCalculated(2, 4); ?>" disabled><input inputmode="numeric" type="number"
                        maxlength="1" min="1" max="9" value="<?php printCell(2, 5); ?>" autocomplete="off"
                        class="<?php colorCalculated(2, 5); ?>" disabled><input inputmode="numeric" type="number"
                        maxlength="1" min="1" max="9" value="<?php printCell(2, 6); ?>" autocomplete="off"
                        class="left <?php colorCalculated(2, 6); ?>" disabled><input inputmode="numeric" type="number"
                        maxlength="1" min="1" max="9" value="<?php printCell(2, 7); ?>" autocomplete="off"
                        class="<?php colorCalculated(2, 7); ?>" disabled><input inputmode="numeric" type="number"
                        maxlength="1" min="1" max="9" value="<?php printCell(2, 8); ?>" autocomplete="off"
                        class="right <?php colorCalculated(2, 8); ?>" disabled><br><input inputmode="numeric"
                        type="number" maxlength="1" min="1" max="9" value="<?php printCell(3, 0); ?>" autocomplete="off"
                        class="top left <?php colorCalculated(3, 0); ?>" disabled><input inputmode="numeric"
                        type="number" maxlength="1" min="1" max="9" value="<?php printCell(3, 1); ?>" autocomplete="off"
                        class="top <?php colorCalculated(3, 1); ?>" disabled><input inputmode="numeric" type="number"
                        maxlength="1" min="1" max="9" value="<?php printCell(3, 2); ?>" autocomplete="off"
                        class="top <?php colorCalculated(3, 2); ?>" disabled><input inputmode="numeric" type="number"
                        maxlength="1" min="1" max="9" value="<?php printCell(3, 3); ?>" autocomplete="off"
                        class="top left <?php colorCalculated(3, 3); ?>" disabled><input inputmode="numeric"
                        type="number" maxlength="1" min="1" max="9" value="<?php printCell(3, 4); ?>" autocomplete="off"
                        class="top <?php colorCalculated(3, 4); ?>" disabled><input inputmode="numeric" type="number"
                        maxlength="1" min="1" max="9" value="<?php printCell(3, 5); ?>" autocomplete="off"
                        class="top <?php colorCalculated(3, 5); ?>" disabled><input inputmode="numeric" type="number"
                        maxlength="1" min="1" max="9" value="<?php printCell(3, 6); ?>" autocomplete="off"
                        class="top left <?php colorCalculated(3, 6); ?>" disabled><input inputmode="numeric"
                        type="number" maxlength="1" min="1" max="9" value="<?php printCell(3, 7); ?>" autocomplete="off"
                        class="top <?php colorCalculated(3, 7); ?>" disabled><input inputmode="numeric" type="number"
                        maxlength="1" min="1" max="9" value="<?php printCell(3, 8); ?>" autocomplete="off"
                        class="top right <?php colorCalculated(3, 8); ?>" disabled><br><input inputmode="numeric"
                        type="number" maxlength="1" min="1" max="9" value="<?php printCell(4, 0); ?>" autocomplete="off"
                        class="left <?php colorCalculated(4, 0); ?>" disabled><input inputmode="numeric" type="number"
                        maxlength="1" min="1" max="9" value="<?php printCell(4, 1); ?>" autocomplete="off"
                        class="<?php colorCalculated(4, 1); ?>" disabled><input inputmode="numeric" type="number"
                        maxlength="1" min="1" max="9" value="<?php printCell(4, 2); ?>" autocomplete="off"
                        class="<?php colorCalculated(4, 2); ?>" disabled><input inputmode="numeric" type="number"
                        maxlength="1" min="1" max="9" value="<?php printCell(4, 3); ?>" autocomplete="off"
                        class="left <?php colorCalculated(4, 3); ?>" disabled><input inputmode="numeric" type="number"
                        maxlength="1" min="1" max="9" value="<?php printCell(4, 4); ?>" autocomplete="off"
                        class="<?php colorCalculated(4, 4); ?>" disabled><input inputmode="numeric" type="number"
                        maxlength="1" min="1" max="9" value="<?php printCell(4, 5); ?>" autocomplete="off"
                        class="<?php colorCalculated(4, 5); ?>" disabled><input inputmode="numeric" type="number"
                        maxlength="1" min="1" max="9" value="<?php printCell(4, 6); ?>" autocomplete="off"
                        class="left <?php colorCalculated(4, 6); ?>" disabled><input inputmode="numeric" type="number"
                        maxlength="1" min="1" max="9" value="<?php printCell(4, 7); ?>" autocomplete="off"
                        class="<?php colorCalculated(4, 7); ?>" disabled><input inputmode="numeric" type="number"
                        maxlength="1" min="1" max="9" value="<?php printCell(4, 8); ?>" autocomplete="off"
                        class="right <?php colorCalculated(4, 8); ?>" disabled><br><input inputmode="numeric"
                        type="number" maxlength="1" min="1" max="9" value="<?php printCell(5, 0); ?>" autocomplete="off"
                        class="left <?php colorCalculated(5, 0); ?>" disabled><input inputmode="numeric" type="number"
                        maxlength="1" min="1" max="9" value="<?php printCell(5, 1); ?>" autocomplete="off"
                        class="<?php colorCalculated(5, 1); ?>" disabled><input inputmode="numeric" type="number"
                        maxlength="1" min="1" max="9" value="<?php printCell(5, 2); ?>" autocomplete="off"
                        class="<?php colorCalculated(5, 2); ?>" disabled><input inputmode="numeric" type="number"
                        maxlength="1" min="1" max="9" value="<?php printCell(5, 3); ?>" autocomplete="off"
                        class="left <?php colorCalculated(5, 3); ?>" disabled><input inputmode="numeric" type="number"
                        maxlength="1" min="1" max="9" value="<?php printCell(5, 4); ?>" autocomplete="off"
                        class="<?php colorCalculated(5, 4); ?>" disabled><input inputmode="numeric" type="number"
                        maxlength="1" min="1" max="9" value="<?php printCell(5, 5); ?>" autocomplete="off"
                        class="<?php colorCalculated(5, 5); ?>" disabled><input inputmode="numeric" type="number"
                        maxlength="1" min="1" max="9" value="<?php printCell(5, 6); ?>" autocomplete="off"
                        class="left <?php colorCalculated(5, 6); ?>" disabled><input inputmode="numeric" type="number"
                        maxlength="1" min="1" max="9" value="<?php printCell(5, 7); ?>" autocomplete="off"
                        class="<?php colorCalculated(5, 7); ?>" disabled><input inputmode="numeric" type="number"
                        maxlength="1" min="1" max="9" value="<?php printCell(5, 8); ?>" autocomplete="off"
                        class="right <?php colorCalculated(5, 8); ?>" disabled><br><input inputmode="numeric"
                        type="number" maxlength="1" min="1" max="9" value="<?php printCell(6, 0); ?>" autocomplete="off"
                        class="top left <?php colorCalculated(6, 0); ?>" disabled><input inputmode="numeric"
                        type="number" maxlength="1" min="1" max="9" value="<?php printCell(6, 1); ?>" autocomplete="off"
                        class="top <?php colorCalculated(6, 1); ?>" disabled><input inputmode="numeric" type="number"
                        maxlength="1" min="1" max="9" value="<?php printCell(6, 2); ?>" autocomplete="off"
                        class="top <?php colorCalculated(6, 2); ?>" disabled><input inputmode="numeric" type="number"
                        maxlength="1" min="1" max="9" value="<?php printCell(6, 3); ?>" autocomplete="off"
                        class="top left <?php colorCalculated(6, 3); ?>" disabled><input inputmode="numeric"
                        type="number" maxlength="1" min="1" max="9" value="<?php printCell(6, 4); ?>" autocomplete="off"
                        class="top <?php colorCalculated(6, 4); ?>" disabled><input inputmode="numeric" type="number"
                        maxlength="1" min="1" max="9" value="<?php printCell(6, 5); ?>" autocomplete="off"
                        class="top <?php colorCalculated(6, 5); ?>" disabled><input inputmode="numeric" type="number"
                        maxlength="1" min="1" max="9" value="<?php printCell(6, 6); ?>" autocomplete="off"
                        class="top left <?php colorCalculated(6, 6); ?>" disabled><input inputmode="numeric"
                        type="number" maxlength="1" min="1" max="9" value="<?php printCell(6, 7); ?>" autocomplete="off"
                        class="top <?php colorCalculated(6, 7); ?>" disabled><input inputmode="numeric" type="number"
                        maxlength="1" min="1" max="9" value="<?php printCell(6, 8); ?>" autocomplete="off"
                        class="top right <?php colorCalculated(6, 8); ?>" disabled><br><input inputmode="numeric"
                        type="number" maxlength="1" min="1" max="9" value="<?php printCell(7, 0); ?>" autocomplete="off"
                        class="left <?php colorCalculated(7, 0); ?>" disabled><input inputmode="numeric" type="number"
                        maxlength="1" min="1" max="9" value="<?php printCell(7, 1); ?>" autocomplete="off"
                        class="<?php colorCalculated(7, 1); ?>" disabled><input inputmode="numeric" type="number"
                        maxlength="1" min="1" max="9" value="<?php printCell(7, 2); ?>" autocomplete="off"
                        class="<?php colorCalculated(7, 2); ?>" disabled><input inputmode="numeric" type="number"
                        maxlength="1" min="1" max="9" value="<?php printCell(7, 3); ?>" autocomplete="off"
                        class="left <?php colorCalculated(7, 3); ?>" disabled><input inputmode="numeric" type="number"
                        maxlength="1" min="1" max="9" value="<?php printCell(7, 4); ?>" autocomplete="off"
                        class="<?php colorCalculated(7, 4); ?>" disabled><input inputmode="numeric" type="number"
                        maxlength="1" min="1" max="9" value="<?php printCell(7, 5); ?>" autocomplete="off"
                        class="<?php colorCalculated(7, 5); ?>" disabled><input inputmode="numeric" type="number"
                        maxlength="1" min="1" max="9" value="<?php printCell(7, 6); ?>" autocomplete="off"
                        class="left <?php colorCalculated(7, 6); ?>" disabled><input inputmode="numeric" type="number"
                        maxlength="1" min="1" max="9" value="<?php printCell(7, 7); ?>" autocomplete="off"
                        class="<?php colorCalculated(7, 7); ?>" disabled><input inputmode="numeric" type="number"
                        maxlength="1" min="1" max="9" value="<?php printCell(7, 8); ?>" autocomplete="off"
                        class="right <?php colorCalculated(7, 8); ?>" disabled><br><input inputmode="numeric"
                        type="number" maxlength="1" min="1" max="9" value="<?php printCell(8, 0); ?>" autocomplete="off"
                        class="bottom left <?php colorCalculated(8, 0); ?>" disabled><input inputmode="numeric"
                        type="number" maxlength="1" min="1" max="9" value="<?php printCell(8, 1); ?>" autocomplete="off"
                        class="bottom <?php colorCalculated(8, 1); ?>" disabled><input inputmode="numeric"
                        type="number" maxlength="1" min="1" max="9" value="<?php printCell(8, 2); ?>" autocomplete="off"
                        class="bottom <?php colorCalculated(8, 2); ?>" disabled><input inputmode="numeric"
                        type="number" maxlength="1" min="1" max="9" value="<?php printCell(8, 3); ?>" autocomplete="off"
                        class="bottom left <?php colorCalculated(8, 3); ?>" disabled><input inputmode="numeric"
                        type="number" maxlength="1" min="1" max="9" value="<?php printCell(8, 4); ?>" autocomplete="off"
                        class="bottom <?php colorCalculated(8, 4); ?>" disabled><input inputmode="numeric"
                        type="number" maxlength="1" min="1" max="9" value="<?php printCell(8, 5); ?>" autocomplete="off"
                        class="bottom <?php colorCalculated(8, 5); ?>" disabled><input inputmode="numeric"
                        type="number" maxlength="1" min="1" max="9" value="<?php printCell(8, 6); ?>" autocomplete="off"
                        class="bottom left <?php colorCalculated(8, 6); ?>" disabled><input inputmode="numeric"
                        type="number" maxlength="1" min="1" max="9" value="<?php printCell(8, 7); ?>" autocomplete="off"
                        class="bottom <?php colorCalculated(8, 7); ?>" disabled><input inputmode="numeric"
                        type="number" maxlength="1" min="1" max="9" value="<?php printCell(8, 8); ?>" autocomplete="off"
                        class="bottom right <?php colorCalculated(8, 8); ?>" disabled><br>
                </div>
            </form>
        </div>
    </div>
